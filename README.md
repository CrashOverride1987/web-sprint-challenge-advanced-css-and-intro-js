...
1. How would you describe acessibility on the web to someone new to programming? How accessible it is to people with disabilites, such as color blindness, blindness and/or deafness.
2. Talk about 3 different things you can do to ensure your website is accessible. Use semantic html, fill out alt tags, color.
3. How would you explain the concept of a variable to someone new to programming? It's like virtual tupperware, you are saving stuff for later.
4. What is the purpose of using functions in code? reusability.
